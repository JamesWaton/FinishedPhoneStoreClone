...
<!-- Successful! at the top is just showing myself that MYSQL is working -->
...
<head>
    ...
    <!-- got this working :) Not Sure why i could not import this file through the normal import style.scss so i made this for the special prices part
...
<header id="header">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-secondary">
        <a class="navbar-brand" href="index.php">JW Mobile Shop</a>
